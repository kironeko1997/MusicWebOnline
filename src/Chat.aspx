<%@ Page Title="" Language="C#" MasterPageFile="~/master_Home.Master" AutoEventWireup="true" CodeBehind="Chat.aspx.cs" Inherits="MusicWebOnline.Chat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="chatleft">
            ...
            <asp:DataList ID="DataList_binhluan" Width="100%" runat="server"
                ...
                <ItemTemplate>
                    <table class="Top_Banner"
                        ...
                        <tr>
                            <td style="width: 50px">
                                <asp:Image ID="Image6" Width="90%" runat="server" BorderStyle="Inset" ImageUrl='<%# "~/img_user/"+Eval("Hinh") %>' />
                            </td>
                            <td style="width: 10px">
                                <img alt="" src="img_button/neen.gif" style="width: 10px; height: 100%" />
                            </td>
        ...
        <p>
            <div class="TieuDe__">&nbsp;&nbsp;&nbsp; Chat</div>
        </p>
        <table class="Top_Banner" style="border-style: solid">
            <tr>
                <td style="width: 60px">
                    <asp:Image ID="Image_user" Width="90%" runat="server" BorderStyle="Inset" ImageUrl="~/img_button/3anh.png" />
                </td>
                <td style="width: 10px">
                    <img alt="" src="img_button/neen.gif" style="width: 10px; height: 100%" />
                </td>
