<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master_Admin.Master" AutoEventWireup="true" CodeBehind="QL_Music.aspx.cs" Inherits="MusicWebOnline.QL_Music" %>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            ...
            <asp:TextBox ID="txt_xoa" runat="server" Width="64px"></asp:TextBox>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ConnectionString="<%$ ConnectionStrings:MusicwebConnectionString %>"
            ...
            <asp:View ID="View2" runat="server">
                <p>
                    Nhập vào số Mã Music cần Tìm :
            <asp:TextBox ID="txt_" runat="server" Width="64px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button
                        ID="btn_" runat="server" Text="Tìm" OnClick="btn__Click" />
                </p>
                <table border="0" style="width: 80%">
                    <tr>
                        <td class="__left" style="height: 26px; text-align: right;">Tên Bài Hát :</td>
                        <td style="text-align: left; height: 26px;">
                            <asp:TextBox ID="txt_tenbaihat" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="text-align: right">Mã Thể Loại :</td>
                        <td style="text-align: left">
                            <asp:TextBox ID="txt_matheloai" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="height: 28px; text-align: right;">&nbsp;Mã Nhạc Sĩ :</td>
                        <td style="text-align: left; height: 28px;">
                            <asp:TextBox ID="txt_manhacsi" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="height: 28px; text-align: right;">Mã Ca Sĩ :</td>
                        <td style="text-align: left; height: 28px;">
                            <asp:TextBox ID="txt_macasi" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="height: 28px; text-align: right;">Mã Album :</td>
                        <td style="text-align: left; height: 28px;">
                            <asp:TextBox ID="txt_maalbum" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="height: 28px; text-align: right;">Nội Dung :</td>
                        <td style="text-align: left; height: 28px;">
                            <asp:TextBox ID="txt_noidung" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="text-align: right">Tên Không Dấu :</td>
                        <td style="text-align: left">
            ...
            <asp:View ID="View3" runat="server">
                <table border="0" style="width: 80%">
                    ...
                    <tr>
                        <td class="__left" style="text-align: right">File Nhạc :</td>
                        <td style="text-align: left">
                    ...
                    <tr>
                        <td style="width: 25%">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                ConnectionString="<%$ ConnectionStrings:MusicwebConnectionString %>"
                                SelectCommand="SELECT [MaAlbum], [TenAlbum] FROM [Album]"></asp:SqlDataSource>
                        </td>
                        <td style="width: 25%">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                ConnectionString="<%$ ConnectionStrings:MusicwebConnectionString %>"
                                SelectCommand="SELECT [MaCaSi], [TenCaSi] FROM [Casi]"></asp:SqlDataSource>
                        </td>
                        <td style="width: 25%">
                        ...
                        <td style="width: 25%">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                ConnectionString="<%$ ConnectionStrings:MusicwebConnectionString %>"
                                SelectCommand="SELECT [MaNhacSi], [TenNhacSi] FROM [Nhacsi]"></asp:SqlDataSource>
                        </td>
                    </tr>
                </table>
            </asp:View>
