<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master_Admin.Master" AutoEventWireup="true" CodeBehind="QL_User.aspx.cs" Inherits="MusicWebOnline.admin.QL_User" %>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            ...
            <asp:View ID="View_AddUser" runat="server">
                <table border="0" style="width: 80%">
                    <tr>
                        <td class="__left" style="height: 26px; text-align: right;">Tên Đăng Nhập :</td>
                        <td style="text-align: left; height: 26px;">
                            <asp:TextBox ID="txt_add_user" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="text-align: right">Mật Khẩu :</td>
                        <td style="text-align: left">
                            <asp:TextBox ID="txt_add_pass" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="height: 28px; text-align: right;">Họ Tên :</td>
                        <td style="text-align: left; height: 28px;">
                            <asp:TextBox ID="txt_add_ten" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="height: 28px; text-align: right;">Giới Tính :</td>
                        <td style="text-align: left; height: 28px;">
                    ...
                    <tr>
                        <td class="__left" style="height: 28px; text-align: right;">Ngày Sinh :</td>
                        <td style="text-align: left; height: 28px;">
                    ...
                    <tr>
                        <td class="__left" style="height: 28px; text-align: right;">Chứng Minh :</td>
                        <td style="text-align: left; height: 28px;">
                            <asp:TextBox ID="txt_add_chungminh" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="__left" style="text-align: right">Mail :</td>
                        <td style="text-align: left">
                    ...
                    <tr>
                        <td class="__left" style="text-align: right">Hình Ảnh :</td>
                        <td style="text-align: left">
