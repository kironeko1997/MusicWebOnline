<%@ Page Title="" Language="C#" MasterPageFile="~/master_Log.Master" AutoEventWireup="true" CodeBehind="Regirter.aspx.cs" Inherits="MusicWebOnline.Regirter" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="login">
        ...
        <div class="_noidung">
            ...
            <div>
                ...
                <p><strong>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                      ForeColor="Red"  ControlToValidate="txt_pass" ErrorMessage="Bạn chưa nhập PassWord"></asp:RequiredFieldValidator>
               </strong> </p>
            </div>
            <div>
                ...
                <p><strong>
                   <asp:CompareValidator ID="CompareValidator1" runat="server" 
                    ...
                    ForeColor="Red"   ErrorMessage="Xác nhận mật khẩu không trùng"></asp:CompareValidator>
                </strong></p>
            </div>
            ...
            <div>
                ...
                <p><strong>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                     ForeColor="Red"  ControlToValidate="txt_hoten" ErrorMessage="Tên của bạn là gì ?"></asp:RequiredFieldValidator>
                </strong></p>
            </div>
            <div>
            ...
            <div>
                <span style="color: #FFFFFF"><strong>CCCD(CMT)</strong></span>
                <br />
                <center>
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                     ForeColor="Red"  ControlToValidate="txt_hochieu" ErrorMessage="Bạn Chưa Nhập Hô Chiếu"></asp:RequiredFieldValidator>
              </strong>  </p>
            </div>
            <div>
                ...
                <center>
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                    ForeColor="Red"   ControlToValidate="txt_email" ErrorMessage="Bạn Chưa Nhập Email "></asp:RequiredFieldValidator>
               </strong> </p>
            </div>
            <div>
