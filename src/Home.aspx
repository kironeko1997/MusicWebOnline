<%@ Page Title="" Language="C#" MasterPageFile="~/master_Home.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="MusicWebOnline.Home" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HyperLink ID="HyperLink1" Text='<%#Eval("TenBaiHat") %>'
        ...
        <div class="AlBum_Hot">
            <p>
                <div class="TieuDe__">&nbsp;&nbsp;&nbsp; AlBum Nổi Bật</div>
            </p>
        ...
        <div class="Video_Hot">
            <p>
                <div class="TieuDe__">&nbsp;&nbsp;&nbsp; Video Nổi Bật</div>
            </p>
        ...
        <div class="Music_Hot">
            <p>
                <div class="TieuDe__">&nbsp;&nbsp;&nbsp; Bài Hát Mới</div>
            </p>
                ...
                <ItemTemplate>
                    <div class="Music___">
                        ...
                        <table class="Top_Banner">
                            <tr>
                                <td style="width: 87%">Trình Bày :<asp:Label ID="Label1" runat="server" Text='<%# Eval("TenCaSi") %>'></asp:Label>
                                    &nbsp;||
        ...
        <div class="Binh_luan">
            <p>
                <div class="TieuDe__">&nbsp;&nbsp;&nbsp; Bình Luận</div>
            </p>
                        ...
                        <table class="Top_Banner"
                            ...
                            <tr>
                                ...
                                <td style="width: 680px">
                                    ...
                                    :<asp:Label ID="Label4" runat="server" Text='<%# Eval("LoiBinh") %>'></asp:Label>
                                </td>
                                <td>
            ...
            <p>
                <div class="TieuDe__">&nbsp;&nbsp;&nbsp; Lời Bình Của Bạn</div>
            </p>
            <table class="Top_Banner" style="border-style: solid">
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;
                        <asp:Button ID="btn_gui" runat="server" Text="OK" />
